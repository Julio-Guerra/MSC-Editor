...
for i in `find ./files/msc96 -name "*.mpr"`; do
    ...
    ./../../build/tests/parse/testpretty-printer 1 $i > first 2>/dev/null;
    ./../../build/tests/parse/testpretty-printer 1 first > second 2>/dev/null;
...
for i in `find ./files/msc2000 -name "*.mpr"`; do
    ...
    ./../../build/tests/parse/testpretty-printer 0 $i > first 2>/dev/null;
    ./../../build/tests/parse/testpretty-printer 0 first > second 2>/dev/null;
    diff first second > /dev/null;
